...
<script language="javascript" src="impress/checker_age.js"></script>
</head>
<body>
	<form method="POST" name="f4" id="f4" enctype="multipart/form-data" action="add_agency_verify.php" onsubmit="return checkAge();">
	<div id="wraper">
	<div id="header">New Agency</div>
	<div id="content">
	<table>
		<tr>
			<td>First name:&nbsp;</td>
		...
		<tr>
			...
			<tr>
			<td>Picture:&nbsp;</td>
			<td><input type="file" name="txtFle" id="txtFle" size="28" 
		...
		<tr>
			<td>E.O.C date</td>
			<td><?php
					  $myCalendar = new tc_calendar("dater3",true,false);
					  $myCalendar->setIcon("calendar/images/iconCalendar.gif");
					  $myCalendar->setPath("calendar/");
					  //$myCalendar->setYearInterval(1932, date("Y"));
					  $myCalendar->setYearInterval(1932, 2025);
					  //$myCalendar->dateAllow("2008-05-13", date("Y-m-d"));
					  $myCalendar->setAlignment("right", "bottom");
					  $myCalendar->writeScript();
					?>
		...
		<tr>
			<td>Group:&nbsp;</td>
			<td><input type="text" name="txtGrp" id="txtGrp" size="10" value="Agency" readonly
				onfocus="cON('Grp');" onblur="cOFF('Grp');" /></td>
		</tr>
		<tr>
			<td>Role:&nbsp;</td>
			<td><input type="text" name="txtRol" id="txtRol" size="10" value="1" readonly
