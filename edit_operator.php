<?php 
	...
	$b1 = "SELECT * FROM tbloptr WHERE ctrlnum='$sid'";
	$b2 = mysql_query($b1);
	$b3 = mysql_fetch_object($b2);
?>
<html>
<head>
<title>Operators Profile</title>
<link rel="stylesheet" type="text/css" media="screen" href="ornament/ornament_edit_trainor.css" />
<script type="text/javascript" src="impress/edt_optr_chk.js"></script>
</head>
<body>
	<div id="wraper">
	<form method="POST" name="edtOptr" id="edtOptr" enctype="multipart/form-data" action="edit_operator_verify.php" onsubmit="return rel_chk();">
	<div id="header">Operator's Profile</div>
	<div id="content">
	<table>
		<tr>
			<td>ID:&nbsp;</td>
