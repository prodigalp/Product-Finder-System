<?php
	...
	$a1 = "
		...
		FROM tbluser t1, tblagency t2 
		WHERE t1.gtype='Agency' && t2.ctrlnum=t1.id ORDER BY t1.fname ASC;";
	$a2 = mysql_query($a1);
	...
	<table id="top">
		<tr>
			...
			style="
				...
				background:#00FF00;
				font-weight:bold;">List of registered user (Agency)</td>
		</tr>
