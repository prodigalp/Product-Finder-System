<?php
	...
	$a1 = "
		...
		FROM tbluser t1, tbltray t2 
		WHERE t1.gtype='Trainor' && t2.ctrlnum=t1.id ORDER BY t1.fname ASC;";
	$a2 = mysql_query($a1);
...
<body>
	<div id="wraper">
	<div id="header"><h2>View Trainor</h2></div>
	<div id="content">
	<table id="top">
		<tr>
			<td colspan="4" 
			style="
				...
				background:#00FF00;
				font-weight:bold;">List of registered user (Trainor)</td>
		</tr>
